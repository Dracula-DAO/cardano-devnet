...
import { loadJambhalaPrivKey, loadJambhalaNativeScript, loadJambhalaPlutusScript, loadJambhalaAddress } from '../../jambhala-utils.mjs'
...
const main = async () => {
  ...
  const referenceUtxo = {
    txHash: "7311d5fe4fec3658f29e772d1c553a74179e8e4691eba4a7bb163fed7463deb7",
    outputIndex: 0
  }
  const referenceUtxos = await lucid.utxosByOutRef([referenceUtxo])

  const tx = await lucid.newTx()
    .collectFrom([stateUtxo], Data.void()) // no redeemer
    .readFrom(referenceUtxos)
